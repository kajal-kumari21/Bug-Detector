...
function populateAssigneesFilter() {
  ...
  filterAssignedTo.innerHTML = '<option value="">All</option>'; // Reset filter options
...
document.getElementById('searchInput').addEventListener('input', updateSearchAutocomplete);
